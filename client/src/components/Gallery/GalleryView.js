...
const GalleryView = () => {
    ...
    const getSingleFilesList = async () => {
        try {
            ...
            setSingleFiles(fileList.reverse());
        } catch (error) {
                ...
                <header className="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
                    ...
                    <ul className="nav nav-pills">
                        <li className="nav-item">
                            <a href="#" className="nav-link docs-creator">Profile</a>
                        </li>
                        <li className="nav-item">
                            <a href="#" className="nav-link docs-creator">Logout</a>
                        </li>
                    </ul>
                </header>
            </div>
            ...
            <div className="row m-4">
                <div className="row m-4">
                    {singleFiles.map((file, index) =>
                        <div className="col-lg-4 mb-4 mb-lg-0" key={file._id}>
                            <div className='border-top'>
                                <p className='p-2 mb-0'>{file.fileName.substring(0, file.fileName.indexOf('.'))}</p>
                            </div>
                            <img
